...
dd %>% 
  ...
  labs(title = "Average Sentiment vs Total Covid-19 Vaccinations and Deaths in the USA",
       x = "Months",
       y = "Covid-19 Rolling Vaccination and Death Totals",
       caption = "Sentiment Score is 0-1 and Scaled for this graphic.
       Data thru March 14, 2021, extra right side units are added to this graph for labels") +
  ...
  scale_x_date(limits = as.Date(c("2020-12-12", "2021-03-14")), 
               # Expands 1 unit to the left, 27 units to the right for the labels
               expand = expansion(add = c(1, 27))) + 
